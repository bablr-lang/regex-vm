import { RegexMatcher } from '@bablr/agast-vm-helpers/symbols';
import { buildPatternInternal } from './internal/regex.js';
import { parseRegexPattern } from '@bablr/agast-vm-helpers/parsers/regex';
...
export class Pattern {
  constructor(expr) {
    ...
    if (expr instanceof Pattern) {
      return expr;
    } else if (expr.type === RegexMatcher) {
      ast = parseRegexPattern(expr.value);
    } else {
      throw new Error();
    }
